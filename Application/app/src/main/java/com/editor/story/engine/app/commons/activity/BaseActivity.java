...
import com.engine.app.adapters.DrawerAdapter;
import com.engine.app.models.DrawerItem;
import com.engine.app.models.SimpleItem;
import com.engine.app.models.SpaceItem;
import com.engine.app.listeners.OnRequestHandlerListener;
import com.engine.widget.SlidingRootNav;
import com.engine.widget.SlidingRootNavBuilder;
...
public abstract class BaseActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    private static final int POS_EDITOR = 0;
    private static final int POS_TUTORIAL = 1;
    private static final int POS_LIBRARY = 2;
    private static final int POS_PROJECT = 3;
	...
	public void initToolbarMenu(Bundle savedInstanceState, String title){
        ...
        DrawerAdapter adapter = new DrawerAdapter(Arrays.asList(
                                                      createItemFor(POS_EDITOR).setChecked(true),
                                                      createItemFor(POS_TUTORIAL),
                                                      createItemFor(POS_LIBRARY),
                                                      createItemFor(POS_PROJECT),
                                                      new SpaceItem(48),
        ...
        adapter.setSelected(POS_EDITOR);
    }
    ...
    public void onItemSelected(int position) {
        ...
        } else if (position == POS_TUTORIAL) {

        } else if (position == POS_LIBRARY) {

        } else if (position == POS_PROJECT) {
