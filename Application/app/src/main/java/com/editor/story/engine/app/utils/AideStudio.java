...
public class AideStudio {
    ...
    private static volatile AideStudio Instance = null;
    private Context context;
    
    public static AideStudio getInstance() {
        AideStudio localInstance = Instance;
        if (localInstance == null) {
            synchronized (AideStudio.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new AideStudio(AppController.getContext());
                }
            }
        }
